...
const page = () => {
  return (
    <div className="decor">
      <Banner text="Оформление картин и фото в багет с паспарту" />
      <Navbar />
      <ResponsiveCatalog />
      <main className="content">
        ...
        <div className="examples">
          ...
          <p className="exampleLastText">
            Звоните и заказывайте по телефону в Санкт-Петербурге +7 (999)
            999-99-99
          </p>
        </div>
        <div>
        ...
        <div>
          ...
          <p className="text">
            ...
            аккуратно сливаться с обрамлением, создавая эффект "растекания" в
            деталях. Такой метод не только подчеркивает глубину произведения, но
            и делает его центральным элементом композиции.
          </p>
          <p className="text">
        ...
        <div>
          <Title text="Основные преимущества оформления в багет" size={36} />
          <div className="adv">
            <p className="text">
