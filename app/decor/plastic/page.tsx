  ...
  return (
    <div className="decorContainer">
      ...
      <main className="mainContent">
        <div>
          <p className="text">
            Оформление ваших произведений искусства в пластиковый багет – это
